...
7. Edit info popups, including caption text, presenter portrait, and optional MP3 path.
8. Edit cards, props, bottom-path icon, and scientist positions.
9. Drag cards, props, info icons, and scientists in the preview.
